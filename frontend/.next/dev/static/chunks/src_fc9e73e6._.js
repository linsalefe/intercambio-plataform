...
function DashboardPage() {
    ...
    const loadStats = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/dashboard/stats');
            setStats(res.data);
        } catch (err) {
...
//# sourceMappingURL=src_fc9e73e6._.js.map