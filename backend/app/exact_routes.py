...
async def bulk_send_template(
    ...
    # Buscar o corpo do template uma única vez para renderizar o texto salvo.
    template_body = await fetch_template_body(
        channel.waba_id, channel.whatsapp_token, template_name, language
    )
